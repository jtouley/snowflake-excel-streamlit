...
import yaml
import os
from datetime import datetime, timedelta  # Updated: Import timedelta from datetime
...
class BronzeIngestor:
    ...
    def _serialize_data(self, df: pd.DataFrame) -> pd.Series:
        ...
        def convert_value(value: Any) -> Any:
            ...
            # Updated: Handle both pandas Timedelta and Python's built-in timedelta
    ...
    def ingest_excel(self, file_path: str) -> None:
        """Process Excel file and upload to Snowflake bronze table."""
        try:
            # Read Excel file
